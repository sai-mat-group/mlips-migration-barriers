...
The "codes" folder provides (i) a Python implementation of the geometry metric defined in Equation 1 of the paper and (ii) model-specific notebooks for running NEBs with each universal potential; each notebook is named after its corresponding potential.
